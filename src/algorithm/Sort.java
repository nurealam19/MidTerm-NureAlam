...
public class Sort {
    ...
    public int[] selectionSort(int[] array) {    //selection sort
    ...
    public int[] insertionSort(int[] array) {              // inseration sort
        final long startTime = System.currentTimeMillis();
        int[] list = array;
        //implement here
    ...
    public int[] bubbleSort(int[] array) {                       // bubble sort
        final long startTime = System.currentTimeMillis();
        int[] list = array;
        //implement here
        int temp;
    ...
    public int[] mergeSort(int [] array, int low, int high){          // merge sort
        final long startTime = System.currentTimeMillis();
        int[] list = array;
        //implement here
    ...
    public int[] bucketSort(int[] array) {                           //bucket sort
        final long startTime = System.currentTimeMillis();
        int[] list = array;
        //implement here
    ...
    public int[] shellSort(int[] array) {                             // sell sort
        final long startTime = System.currentTimeMillis();
        int[] list = array;
        //implement here
